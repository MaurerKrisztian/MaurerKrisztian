...
- [MaurerKrisztian/issue-improver-action](https://github.com/MaurerKrisztian/issue-improver-action) - GitHub Action that automates issue improvement suggestions using OpenAI GPT-3. (3 days ago)
...
- [withastro/astro](https://github.com/withastro/astro) ([astro@2.3.4](https://github.com/withastro/astro/releases/tag/astro%402.3.4), 1 day ago) - The all-in-one web framework designed for speed. ⭐️ Star to support our work!
- [novuhq/novu](https://github.com/novuhq/novu) ([v0.14.0](https://github.com/novuhq/novu/releases/tag/v0.14.0), 5 days ago) - The open-source notification infrastructure with fully functional embedded notification center
...
- [Improve GitHub issues with AI 🦾](https://dev.to/maurerkrisztian/improve-github-issues-with-ai-4lam) (6 days ago)
...
- [MaurerKrisztian/issue-improver-action](https://github.com/MaurerKrisztian/issue-improver-action) - GitHub Action that automates issue improvement suggestions using OpenAI GPT-3. (1 week ago)

...
- [MaurerKrisztian/music-visualizer](https://github.com/MaurerKrisztian/music-visualizer) - web based music visualizer (3 days ago)
- [MaurerKrisztian/template-client](https://github.com/MaurerKrisztian/template-client) (3 weeks ago)
...
- [nestjs/nest](https://github.com/nestjs/nest) ([v10.3.0](https://github.com/nestjs/nest/releases/tag/v10.3.0), 2 weeks ago) - A progressive Node.js framework for building efficient, scalable, and enterprise-grade server-side applications with TypeScript/JavaScript 🚀
...
- [MaurerKrisztian/music-visualizer](https://github.com/MaurerKrisztian/music-visualizer) - web based music visualizer (4 days ago)
- [lightrail-ai/lightrail](https://github.com/lightrail-ai/lightrail) - Lightrail Monorepo (3 months ago)
